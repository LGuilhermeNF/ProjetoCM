...
begin
  try
    ...
    begin
      ...
      MessageBox(handle,'Processo concluido.','Informação', MB_ICONINFORMATION + MB_OK);
    end
    else
    begin
      MessageBox(handle,'Necessário conectar com aplicação.','Informação', MB_ICONINFORMATION + MB_OK);
    end;
  finally
